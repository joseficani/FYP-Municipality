...
export default function ContactModule() {
  ...
  return (
    <>
      ...
      {showSuccessPopup && (
        <div className="contactModalOverlay" onClick={closeSuccessPopup}>
          <div
            className="contactModalCard"
          ...
          >
            ...
            <div className="contactModalIconWrap">
              <CheckCircle2 size={44} />
            </div>

            <h3 className="contactModalTitle">Message Sent</h3>
...
function ContactForm({ onSubmit, formData, setFormData, isSubmitting }) {
  return (
    <div className="contact-card">
      <h2>Send Us a Message</h2>
      <p className="contact-card-subtitle">
